...
new function() {
    ...
    $.fn.validate = {
     ...
     function doSuccess(o) {
              $('#' + o.id + '_img').html('<img src="img/accept.png" border="0" width=20 style="float:left;" />');
     ...
     function doError(o,m) {
              $('#' + o.id + '_img').html('<img src="img/exclamation.png" border="0" width=20 style="float:left;" />');
     ...
     function doValidate(o) {
        	$('#' + o.id + '_img').html('<img src="img/loading.png" border="0" width=20 style="float:left;" />');
...
$.fn.match = function(m) {
	$('#' + this.get(0).id + '_img').html('<img src="img/loading.png" border="0" width=20 style="float:left;" />');
	if ($(this).get(0).val() == $(m.match).val()) {
          $('#' + this.get(0).id + '_img').html('<img src="img/accept.png" border="0" width=20 style="float:left;" />');
          $(m.error).removeClass("error");
          $(m.error).addClass("success");
          $('#' + this.get(0).id + '_msg').html("");
        } else {
          $('#' + this.get(0).id + '_img').html('<img src="img/exclamation.png" border="0" width=20 style="float:left;" />');
